...
<p class="hint">Keep AIEdge powered during installation. Device address: <a id="device-address" hidden></a><span id="address-pending">waiting for network details</span>.</p></main>
<script>
