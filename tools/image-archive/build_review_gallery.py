...
def build(archive,protection,group_id,output,offset=0,limit=6):
    ...
    review=prepare(archive,protection)
    ...
    manifest=dict(version=1,group_id=group_id,identity=group['identity'],images=selected,protected_manifest_sha256=review['protected_manifest_sha256'],training_eligible=False,limits=review['limits'])
...
def main():
    ...
    a=p.parse_args()
    try:build(a.archive,a.protected_hashes,a.group,a.output,a.offset,a.limit)
